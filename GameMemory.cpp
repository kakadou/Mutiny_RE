...
{
	return g_ClientState->m_nServerTick + TIME_TO_TICKS(g_LagCompensation.GetLerpTime());
}

int GetServerTick()
{
	return g_ClientState->m_nServerTick;
}

float GetServerTime()
{
	return TICKS_TO_TIME(g_ClientState->m_nServerTick);
}
